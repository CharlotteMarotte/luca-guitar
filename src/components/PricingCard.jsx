      ...
      <div
        className={
          pricingPlan.isHighlighted
            ? 'flex flex-col p-6 mx-auto text-center text-sambuca bg-sand rounded-3xl border-4 border-white shadow h-auto sm:transform sm:translate-y-[-15px] sm:z-10'
            : 'flex flex-col p-6 mx-auto text-center text-sambuca bg-sand rounded-3xl border-4 border-spicyMustard shadow h-auto'
        }
      >
