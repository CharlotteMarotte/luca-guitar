  ...
  return (
    ...
    >
      <div className="w-full px-4">
        <div className="p-6 rounded-lg bg-sambuca bg-opacity-40 animate-fade">
          <h2
            className="text-3xl sm:text-4xl lg:text-5xl font-heading mb-4 animate-fade"
            style={{ animationDelay: "1000ms" }}
          >
            Entdecke die Welt der Gitarre – Dein musikalischer Weg beginnt hier!
          </h2>
          <p className="text-lg sm:text-xl font-body animate-fade">
