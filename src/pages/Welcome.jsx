const Welcome = () => {
  return (
    <section id='welcome' className='flex items-center justify-center text-center text-textLight py-16 sm:py-24 lg:py-32 z-10'>
      <div className='w-full px-4'>
        <div className='p-6 rounded-lg bg-textDark bg-opacity-40'>
          <h2 className='text-3xl sm:text-4xl lg:text-5xl  mb-4 zoom-in'>
