...
const About = () => {
  return (
    <PageScaffold bgColor='bg-primary'>
      <section id='about' className='text-textLight py-20 min-h-screen flex items-center justify-center' aria-labelledby='about-header'>
        <div className='container flex flex-col lg:flex-row items-center px-8 md:px-20 gap-8 md:gap-16'>
          <div className='flex-1'>
            <AnimateOnScroll>
              <h1 id='about-header' className='text-center md:text-left text-3xl sm:text-4xl md:text-5xl mb-6' tabIndex='0'>
                Über mich
              </h1>
            </AnimateOnScroll>
            <AnimateOnScroll>
              <p className='text-lg text-center md:text-justify mb-6' tabIndex='0'>
            ...
            <AnimateOnScroll>
              <p className=' text-lg text-center md:text-justify sm:text-left' tabIndex='0'>
