      ...
      >
        <div className="container flex flex-col lg:flex-row items-center px-8 md:px-20 gap-8 md:gap-16">
          <div className="flex-1">
            <AnimateOnScroll>
              <h1 className="text-center md:text-left text-3xl sm:text-4xl md:text-5xl font-heading mb-6">
                Über mich
              </h1>
            </AnimateOnScroll>
            <AnimateOnScroll>
              <p className="font-body text-lg md:text-justify mb-6">
                ...
                klassischen Gitarrenunterricht genommen, später verschiedene
                Stile wie Jazz und Flamenco ausprobiert und vieles auch
            ...
            <AnimateOnScroll>
              <p className="font-body text-lg md:text-justify mb-6">
                ...
                Komponieren eigener Stücke und der Produktion elektronischer
                Musik. Zudem habe ich auch schon Filmmusik produziert und werde
                immer wieder für solche Projekte engagiert – ein spannendes
                Feld, das meine kreative Arbeit immer wieder auf neue Weise
                herausfordert.
              </p>
            </AnimateOnScroll>
            <AnimateOnScroll>
