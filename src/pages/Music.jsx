...
const Music = () => {
  ...
  return (
    <div>
      <PageScaffold title="Meine Musik" backgroundImage={svgPaarlNoiseBase64}>
        <section className=" text-white min-h-screen flex flex-col items-center justify-between">
